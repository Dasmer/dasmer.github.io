var friendsDictionary = [
 ...
 },
 {
   ...
   "Season": 5,
   "Episode": 3,
   "Title": "\"The One with the Triplets\"",
   "Director": "Kevin S. Bright"
 },
 {
   "Number": 101,
 ...
 },
 {
   ...
   "Director": "Kevin S. Bright & Gary Halvorson"
 },
 {
   "Number": 169,
   "Season": 7,
...
function generateFriendsRecommendation() {
  var show_number = Math.floor(Math.random() * 236);
document.getElementById("show").innerHTML =  "Watch " + friendsDictionary[show_number]["Title"] + "<br />Season #" + friendsDictionary[show_number]["Season"] + ", Episode #" + friendsDictionary[show_number]["Episode"];
}
